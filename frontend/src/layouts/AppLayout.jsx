...
export default function AppLayout() {
  ...
  const menu = useMemo(() => {
    ...
    return [
      ...
      { label: "Operasional", icon: FiTruck, items: [{ to: "/trucks", label: "Armada", icon: FiTruck }, { to: "/fleet-map", label: "Peta Armada", icon: FiMap }, { to: "/operational-locations", label: "Master Lokasi", icon: FiMapPin }, { to: "/material-stock", label: "Ambang / Material", icon: FiBox }, { to: "/orders", label: "Pesanan", icon: FiFileText }, { to: "/trips", label: "Trips", icon: FiMap }] },
      ...
      { label: "Keuangan", icon: FiDollarSign, items: [{ to: "/expenses", label: "Pengeluaran", icon: FiDollarSign }, { to: "/receivables", label: "Piutang", icon: FiCreditCard }, ...((isOwnerAdmin || isStaff) ? [{ to: "/fleet-profitability", label: "Profit Armada", icon: FiPieChart }] : []), ...(isOwnerAdmin ? [{ to: "/accounting", label: "Accounting", icon: FiBookOpen }] : [])] },
  ...
  }, [role, isDriver, isSparepartAdmin, isOwnerAdmin, isStaff, canManageDrivers]);
