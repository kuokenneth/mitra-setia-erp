...
export default function Purchasing() {
  ...
  const [receiptForm, setReceiptForm] = useState({ locationId: "", locationName: "Gudang Utama", quantities: {}, serials: {}, deliveryNote: "", notes: "", supplierInvoiceNumber: "", supplierInvoiceDate: "", supplierInvoiceAmount: "" });
  ...
  function openReceiptForm(po) {
    ...
    setReceiptForm({ locationId: data.locations[0]?.id || "", locationName: "Gudang Utama", quantities: Object.fromEntries(po.items.map(i => [i.id, i.qty - i.receivedQty])), serials: Object.fromEntries(po.items.map(i => [i.id, ""])), deliveryNote: "", notes: "", supplierInvoiceNumber: "", supplierInvoiceDate: "", supplierInvoiceAmount: String(poTotal(po)) });
